...
public class AllocMem : MonoBehaviour {
    ...
    public void OnGUI () {
        ...
        heapSize = (int)Profiler.usedHeapSize;

        StringBuilder text = new StringBuilder ();

        text.Append ("Currently allocated        ");
        text.Append ((allocMem/1000000F).ToString ("0.000"));
        text.Append ("mb\n");

        text.Append ("Peak allocated             ");
        text.Append ((peakAlloc/1000000F).ToString ("0.000"));
        text.Append ("mb (last  collect ");
        text.Append ((collectAlloc/1000000F).ToString ("0.000"));
        text.Append (" mb)\n");
        ...
        text.Append ("Heap size                     ");
        text.Append ((heapSize/1000000F).ToString ("0"));
        text.Append ("mb");
        ...
        GUI.Box (new Rect (5,5,350,96+(showFPS ? 16 : 0)),"");
