...
//	}
    ...
    public virtual void OnFinishedMonsterAnim(string type)
    {
        ...
        if(type == "attack" && _gameState == GameState.GAME_READY) {
            ...
            _timer -= _currentMonster._attackPoint;
            _UI_PlayerHP.fillAmount = _timer / _playerMaxHP;
